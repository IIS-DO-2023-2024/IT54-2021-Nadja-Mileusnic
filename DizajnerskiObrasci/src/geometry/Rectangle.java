...
public Rectangle(Point point, int width, int height, boolean b, Color borderColorRectangle, Color innerColorRectangle) {
	this(point, width, height, b);
	this.setColor(borderColorRectangle);
	this.setInnerColor(innerColorRectangle);
}
